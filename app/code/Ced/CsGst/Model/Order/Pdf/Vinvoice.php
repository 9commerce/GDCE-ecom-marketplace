...
class Vinvoice extends \Ced\CsOrder\Model\Order\Pdf\Invoice
{
    ...
    public function getPdf($invoices = [])
    {
        ...
        foreach ($invoices as $invoice) {
            ...
            $this->insertDocumentNumber($page, __('Invoice # ') . $invoice->getIncrementId().'   GSTIN: '.$this->vendorFactory->create()->load($vendorId)->getVendorGstin());
            /* Add table */
     ...
     */
    protected function insertOrder(&$page, $obj, $putOrderId = true, $invoiceData = null)
    {
