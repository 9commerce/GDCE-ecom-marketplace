        ...
        foreach ($collection as $category) {
            ...
            if ($pathSize > 1) {
                ...
                for ($i = 1; $i < $pathSize; $i++) {
                    $name = ($collection->getItemById($structure[$i]) != null) ? $collection->getItemById($structure[$i])->getName() : null;
