 ...
 */
namespace Ced\CsMarketplace\Model\ResourceModel\Customer\Grid;
...
use Ced\CsMarketplace\Model\ResourceModel\Vorders\CollectionFactory as MarketplaceVorderCollection;
...
class Collection extends SearchResult
{
    ...
    /**
     * @var MarketplaceVorderCollection
     */
    private $vorderCollection;
     ...
     * @param MarketplaceVorderCollection $vorderCollection
    ...
    public function __construct(
        ...
        MarketplaceVorderCollection $vorderCollection,
        ...
        $this->vorderCollection = $vorderCollection;
    ...
    {
        parent::_initSelect();
        $this->addFieldToFilter('entity_id',['in'=>$this->getVendorCustomerId()]);
    ...
    protected function getVendorCustomerId(){

        $vordersCollectionData = $this->vorderCollection->create()->addFieldToFilter('vendor_id',$this->customerSession->getVendorId());
        $connection = $this->getConnection();
        $realOrderIdField = $connection->quoteIdentifier('main_table.real_order_id');
        $vordersCollectionData->getSelect()
            ->joinLeft(
                ['sales_table' => $this->getTable('sales_order')],
                "sales_table.entity_id={$realOrderIdField}",
                ['customer_id'=>'customer_id']
            );
        $customer_ids = $vordersCollectionData->getColumnValues('customer_id');
        return $customer_ids;
