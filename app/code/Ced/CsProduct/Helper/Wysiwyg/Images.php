...
class Images extends AbstractHelper
{
    ...
    {
        if ($vendorId = $this->customerSession->getVendorId()) {
            $vendor = $this->customerSession->getVendor();
            return 'wysiwyg/ced/csproduct/' . $vendor['public_name'] . '_' . $vendorId;
        }
        return 'wysiwyg/ced/csproduct/default';
    }
    ...
    public function getImageHtmlDeclaration($filename, $renderAsTag = false)
    {
        ...
        if ($renderAsTag) {
            ...
            if ($this->isUsingStaticUrlsAllowed()) {
                ...
                $html = $this->_urlInterface->getUrl(
