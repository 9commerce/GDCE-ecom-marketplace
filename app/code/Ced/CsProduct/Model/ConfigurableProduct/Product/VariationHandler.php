...
class VariationHandler
{
    ...
    /**
     * @var \Ced\CsProduct\Model\Vproducts
     */
    protected $vproducts;
     ...
     * @param \Ced\CsProduct\Model\Vproducts $vproducts
     */
    public function __construct(
        ...
        \Ced\CsProduct\Model\Vproducts $vproducts
    ) {
        ...
        foreach ($productsData as $simpleProductData) {
            ...
            if (isset($simpleProductData['configurable_attribute'])) {
                ...
                throw new LocalizedException(
                    __('Configuration must have specified attributes. Enter attributes and try again.')
                );
            }
