...
namespace Ced\CsProduct\Ui\DataProvider\Product\Config\Data;
    ...
    protected function prepareVariations()
    {
        ...
        if ($variations) {
            ...
            foreach ($variations as $variation) {
                ...
                $attributeKey = implode('-', $attributeValues);
                if (isset($productByUsedAttributes[$attributeKey])) {
                    $product = $productByUsedAttributes[$attributeKey];
