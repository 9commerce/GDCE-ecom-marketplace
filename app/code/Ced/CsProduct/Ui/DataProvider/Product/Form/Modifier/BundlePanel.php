            ...
            [
                ...
                'children' => [
                    'modal' => [
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'dataScope' => '',
                                    'provider' => 'product_forms.product_form_data_source',
                                    'options' => [
                                        ...
                                        'buttons' => [
                                            ...
                                            [
                                                ...
                                                'actions' => [
                                                    [
                                                        'targetName' => 'index = bundle_product_listings',
                                                        'actionName' => 'save'
                                                    ],
                                                    'closeModal'
                                                ],
                        ...
                        'children' => [
                            'bundle_product_listings' => [
                                'arguments' => [
                                    'data' => [
                                        'config' => [
                                            'autoRender' => false,
                                            'componentType' => 'insertListing',
                                            'dataScope' => 'bundle_product_listings',
                                            'externalProvider' =>
                                                'bundle_product_listings.bundle_product_listings_data_source',
                                            'selectionsProvider' =>
                                                'bundle_product_listings.bundle_product_listings.product_columns.ids',
                                            'ns' => 'bundle_product_listings',
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'actions' => [
                                    [
                                        'targetName' => 'product_forms.product_forms.'
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'provider' => 'product_forms.product_form_data_source',
                        'listingDataProvider' => 'bundle_product_listings',
                        'actions' => [
                            [
                                'targetName' => 'product_forms.product_forms.' . static::CODE_BUNDLE_DATA . '.modal',
                                'actionName' => 'toggleModal'
                            ],
                            [
                                'targetName' => 'product_forms.product_forms.' . static::CODE_BUNDLE_DATA
                                    . '.modal.bundle_product_listings',
                                'actionName' => 'render'
                            ]
                        ],
                        'title' => __('Add Products to Option'),
